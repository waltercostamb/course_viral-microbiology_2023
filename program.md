...
| MON | TUE | WED | THU | FRI |
| -------- | --------  | --------- | --------- | --------- |
| <ul><li>Get acquainted with program</li><li>Documentation theory</li><li>Introduction to Computational Biology I</li><li>Download sequences</li><li>Write on the Lab Book (LB)</li></ul> | <ul><li>Introduction to Computational Biology II</li><li>Evaluate sequencing quality</li><li>LB</li></ul> | <ul><li>Assembly I</li><li>Lecture: Sequence Alignment</li><li>LB</li></ul> | <ul><li>Assembly II</li><li>LB</li></ul> | <ul><li>Identification of phages I</li><li>LB</li></ul> |
| MON | TUE | WED | THU | FRI |
